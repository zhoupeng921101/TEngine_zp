...
namespace PSDUIImporter
{
    internal class InputFieldLayerImport : ILayerImport
    {
        ...
        public void DrawLayer(Layer layer, GameObject parent)
        {
            ...
            inputfield.image.type = UnityEngine.UI.Image.Type.Sliced;
                ...
                if (_temp.image != null)
                {
                    ...
                    else
                    {
                        if (image.name.ToLower().Contains("background"))
                        {
                            ...
                            if (image.imageType == ImageType.Image || image.imageType == ImageType.Texture)
                            {
                                inputfield.image.type = UnityEngine.UI.Image.Type.Simple;
                            }
                        }
                    }
                    //}
