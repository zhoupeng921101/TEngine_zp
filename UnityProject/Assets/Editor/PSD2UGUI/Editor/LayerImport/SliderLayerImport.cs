    ...
    public class SliderLayerImport : ILayerImport
    {
        ...
        public void DrawLayer(Layer layer, GameObject parent)
        {
            ...
            for (int i = 0; i < layer.layers.Length; i++)
            {
                ...
                if (image.name.ToLower().Contains("_bg"))
                {
                ...
                else if (image.name.ToLower().Contains("_fill"))
                {
                ...
                else if (image.name.ToLower().Contains("_handle"))       //默认没有handle
                {
                    ...
                    handleRectTrans.sizeDelta = new Vector2(image.size.width, 0);
