...
// 只内置库核心 Slicer/SlicedTexture/SliceOptions 三件；刻意不内置 Auto9SliceTester——
// 后者会把裁剪结果回写源 PNG 并改源 importer.spriteBorder（破坏式），本工程只需 border-only 提取。
// 原文件 Assets/Auto9Slicer/Editor/Auto9Slicer.cs（类名 Slicer，故文件改名 Slicer.cs 与类名对齐）。
using System.Linq;
using UnityEngine;
