...
namespace GameLogic
{
	public partial class MergeOrderWindow : UIWindow
	{
		...
		private Text m_text_SynthEmpty = null!;
		...
		protected override void ScriptGenerator()
		{
			...
			m_img_BoxCard = m_bindComponent.GetComponent<Image>(11);
			m_btn_OpenBox = m_bindComponent.GetComponent<Button>(12);
			...
			m_rect_BoardLayer = m_bindComponent.GetComponent<RectTransform>(16);
			m_rect_OrderLayer = m_bindComponent.GetComponent<RectTransform>(17);
			m_rect_OrderContent = m_bindComponent.GetComponent<RectTransform>(18);
			m_img_ElemBar = m_bindComponent.GetComponent<Image>(19);
			m_rect_SynthLayer = m_bindComponent.GetComponent<RectTransform>(20);
			m_text_SynthEmpty = m_bindComponent.GetComponent<Text>(21);
			m_img_ClearHintBg = m_bindComponent.GetComponent<Image>(22);
			m_text_ClearHint = m_bindComponent.GetComponent<Text>(23);
			m_img_SlotBg = m_bindComponent.GetComponent<Image>(24);
			m_rect_SlotLayer = m_bindComponent.GetComponent<RectTransform>(25);
			m_btn_ClearTool = m_bindComponent.GetComponent<Button>(26);
			m_btn_Temple = m_bindComponent.GetComponent<Button>(27);
			m_btn_Exit = m_bindComponent.GetComponent<Button>(28);
			m_img_ClearOverlay = m_bindComponent.GetComponent<Image>(29);
			m_rect_GhostLayer = m_bindComponent.GetComponent<RectTransform>(30);
