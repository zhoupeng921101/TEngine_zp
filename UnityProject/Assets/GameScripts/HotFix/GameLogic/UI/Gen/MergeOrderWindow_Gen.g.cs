...
namespace GameLogic
{
	public partial class MergeOrderWindow : UIWindow
	{
		...
		private RectTransform m_rect_EnergyCountdownSlot = null!;
		...
		private RectTransform m_rect_OrderCountdownSlot = null!;
		...
		protected override void ScriptGenerator()
		{
			...
			m_rect_EnergyCountdownSlot = m_bindComponent.GetComponent<RectTransform>(2);
			...
			m_img_BoxCard = m_bindComponent.GetComponent<Image>(10);
			m_btn_OpenBox = m_bindComponent.GetComponent<Button>(11);
			m_text_BlindBox = m_bindComponent.GetComponent<Text>(12);
			m_text_Piety = m_bindComponent.GetComponent<Text>(13);
			m_rect_OrderLayer = m_bindComponent.GetComponent<RectTransform>(14);
			m_rect_OrderContent = m_bindComponent.GetComponent<RectTransform>(15);
			m_rect_OrderCountdownSlot = m_bindComponent.GetComponent<RectTransform>(16);
			m_img_ElemBar = m_bindComponent.GetComponent<Image>(17);
			m_rect_SynthLayer = m_bindComponent.GetComponent<RectTransform>(18);
			m_img_BoardOuter = m_bindComponent.GetComponent<Image>(19);
			m_rect_BoardLayer = m_bindComponent.GetComponent<RectTransform>(20);
			m_img_SlotBg = m_bindComponent.GetComponent<Image>(21);
			m_rect_SlotLayer = m_bindComponent.GetComponent<RectTransform>(22);
			...
			m_img_ClearHintBg = m_bindComponent.GetComponent<Image>(27);
			m_text_ClearHint = m_bindComponent.GetComponent<Text>(28);
			m_rect_GhostLayer = m_bindComponent.GetComponent<RectTransform>(29);
