...
namespace GameLogic
{
	public partial class MergeOrderWindow : UIWindow
	{
		...
		protected override void ScriptGenerator()
		{
			...
			m_rect_ElemLayer = m_bindComponent.GetComponent<RectTransform>(18);
			m_rect_SynthLayer = m_bindComponent.GetComponent<RectTransform>(19);
			m_text_SynthEmpty = m_bindComponent.GetComponent<Text>(20);
			m_rect_OrderLayer = m_bindComponent.GetComponent<RectTransform>(21);
