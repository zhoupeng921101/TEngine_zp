...
namespace GameLogic
{
	public partial class MergeOrderWindow : UIWindow
	{
		...
		protected override void ScriptGenerator()
		{
			...
			m_img_Energy = m_bindComponent.GetComponent<Image>(1);
			m_text_Energy = m_bindComponent.GetComponent<Text>(2);
			...
			m_img_BoardOuter = m_bindComponent.GetComponent<Image>(14);
			m_rect_BoardLayer = m_bindComponent.GetComponent<RectTransform>(15);
			m_rect_OrderLayer = m_bindComponent.GetComponent<RectTransform>(16);
			m_rect_OrderContent = m_bindComponent.GetComponent<RectTransform>(17);
			m_img_ElemBar = m_bindComponent.GetComponent<Image>(18);
			m_rect_SynthLayer = m_bindComponent.GetComponent<RectTransform>(19);
			m_img_SlotBg = m_bindComponent.GetComponent<Image>(20);
			m_rect_SlotLayer = m_bindComponent.GetComponent<RectTransform>(21);
			m_btn_ClearTool = m_bindComponent.GetComponent<Button>(22);
			m_btn_Temple = m_bindComponent.GetComponent<Button>(23);
			m_btn_Exit = m_bindComponent.GetComponent<Button>(24);
			m_img_ClearOverlay = m_bindComponent.GetComponent<Image>(25);
			m_img_ClearHintBg = m_bindComponent.GetComponent<Image>(26);
			m_text_ClearHint = m_bindComponent.GetComponent<Text>(27);
