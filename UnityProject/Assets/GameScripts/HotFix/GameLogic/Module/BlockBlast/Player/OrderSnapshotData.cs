...
namespace GameLogic.BlockBlast.Player
{
    ...
    public sealed class OrderSnapshotData
    {
        ...
        /// <summary>单次交付奖励体力(客户端 toast 预读;实发由服务端落账)。</summary>
        public readonly int OrderRewardEnergy;

        public OrderSnapshotData(List<OrderItemData> activeOrders, int orderCursor,
            long lastOrderRefreshMs, int orderRefreshIntervalSec, int orderRewardEnergy)
        {
            ...
            OrderRewardEnergy = orderRewardEnergy;
        }
    }
